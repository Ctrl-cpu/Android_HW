...
public class myLayoutManager extends LinearLayoutManager {
    ...
    public void onAttachedToWindow(RecyclerView view) {
        ...
        //view.addOnChildAttachStateChangeListener((RecyclerView.OnChildAttachStateChangeListener) this);
    ...
    public void onScrollStateChanged(int state) {
        switch (state){
            ...
            case RecyclerView.SCROLL_STATE_SETTLING:
                View viewSetting = mPagerSnapHelper.findSnapView(this);
                int positionSetting = getPosition(viewSetting);
                break;
        }
